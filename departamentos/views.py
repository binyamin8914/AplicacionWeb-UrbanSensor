...
def incidencias_por_estado(request, estado=None):
    ...
    return render(request, "incidencias/incidencias_listar.html", context)
...
def incidencia_ver_y_derivar(request, incidencia_id):
    ...
    return render(request, "incidencias/incidencia_detalle.html", context)